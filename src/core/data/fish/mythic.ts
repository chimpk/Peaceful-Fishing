...
export const MYTHIC_FISH: FishType[] = [
  ...
  // Cá Rồng Bạch Tạng
  { name: 'Cá Rồng Bạch Tạng', rarity: Rarity.MYTHIC, value: 150000, tension: 98, color: '#ffffff', size: 80, weight: 0.02, allowedLocations: ['CAVE'], allowedTimes: ['NIGHT'], preferredBaits: ['bait_natural_2'], canBerserk: true },
  // Hải Tượng Long
  { name: 'Hải Tượng Long', rarity: Rarity.MYTHIC, value: 200000, tension: 99, color: '#064e3b', size: 150, weight: 0.01, allowedLocations: ['OCEAN'], behavior: FishBehavior.AGGRESSIVE, preferredBaits: ['bait_natural_2'], canBerserk: true },
  // Cá Pha Lê Tím
