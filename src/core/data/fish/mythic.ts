...
export const MYTHIC_FISH: FishType[] = [
  ...
  // Cá Cổ Đại Megalodon
  { name: 'Cá Cổ Đại Megalodon', rarity: Rarity.MYTHIC, value: 45000, tension: 99, color: '#475569', size: 180, weight: 0.01, allowedLocations: ['OCEAN'], behavior: FishBehavior.AGGRESSIVE, preferredBaits: ['bait_sea_3'], canBerserk: true },
  // Cá Rồng Biển Lá
